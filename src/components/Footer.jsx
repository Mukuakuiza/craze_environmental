...
const Footer = () => {
  return (
    <>
      <footer className="bg-white dark:bg-black border-t-4 text-white border-lime-500">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              <a href="#" className="text-black hover:text-lime-500">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
              ...
              <a href="#" className="text-black hover:text-lime-500 ms-5">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
